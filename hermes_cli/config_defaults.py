...
DEFAULT_CONFIG = {
    ...
    "web": {
        ...
        # Ordered, explicit opt-in search failover. Providers are tried only
        # after the selected provider returns success=False; a legitimate
        # success with zero results is never retried as an outage.
        "search_fallbacks": [],
