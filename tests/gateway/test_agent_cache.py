...
class TestAgentCacheSpilloverLive:
    ...
    def test_concurrent_inserts_settle_at_cap(self, monkeypatch):
        ...
        # Keep the concurrency stress meaningful but bounded. AIAgent
        # construction performs provider/auxiliary setup, so 160 real agents can
        # exceed the suite's 30s per-test alarm on constrained CI/dev hosts.
        N_THREADS = 4
